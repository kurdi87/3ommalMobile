<div class="row addpro" style="padding: 20px;">
    ...
    <div class="col-md-12">
        <div class="form-group input-wlbl  @if ($errors->has('procedure')) has-error @endif">
            <span class="">Procedure Name - اسم الإجراء</span>

            {!! Form::text('commitment_id',isset($result->id)?$result->id:"0",['class'=>'hidden commitment_id form-control']) !!}
    ...
    <div class="col-md-6">
        <div class="form-group input-wlbl  @if ($errors->has('costdolar')) has-error @endif">
            <span class="text-success">Total Cost $ - التكلفة بالدولار</span>
    ...
    <div class="col-md-6">
        <div class="form-group input-wlbl  @if ($errors->has('costnis')) has-error @endif">
            <span class="text-success">Total Cost ILS - المجموع شقل</span>
    ...
    <div class="col-md-12">
        <div class="form-group input-wlbl  @if ($errors->has('about_procedure')) has-error @endif">
            <span>About Procedure - عن الإجراء</span>
