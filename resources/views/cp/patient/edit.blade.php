...
@section('js')
    ...
    <script src="cp/js/patientForm.js" type="text/javascript"></script>

    <script src="cp/js/patientAtt.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\PatientController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.patient.form')
        {!! Form::close() !!}
    </div>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <a title="Add Atts" data-modal="modal-attadd" class="attmodal btn btn-circle btn-icon-only btn-default tooltip-one-info" data-id="{{$result->id}}"   href="#">
                                <i class="fa fa-plus"> </i>
                            </a> Click Here To Add Atts To This Patient
                        </div>
                    </div>
