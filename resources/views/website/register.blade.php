...
<div class="main circles-bg">
    <div class="container">
        <div class="login">
            ...
            <form class="ajaxForm myform" id="myform" action="{{ config('app.user_route_name')}}/create"
                  method="post">
            ...
            <div class="modal-dialog" role="document" id="modal-view">
                <div class="modal-content">
                    <div class="box-container">
                        ...
                        <form class="ajaxForm myform" id="myform" action="{{ config('app.user_route_name')}}/verify"
                              method="post">
                            <div class="box-content text-center">
                                ...
                                <div class="m-b-20">
                                    ...
                                    <input type="number" name="verification_key" class="input-confirm" maxlength="6"/>
                                </div>
                        ...
                        <div class="box-content text-center">
                            <form class="ajaxForm myform" id="myform"
                                  action="{{ config('app.user_route_name')}}/sendCode"
                                  method="post">
