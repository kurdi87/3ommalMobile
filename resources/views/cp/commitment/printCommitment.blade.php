@php
    if (isset($commitment->finance_party))
{
$finance_party=$commitment->finance_party;
}
$finance_party=4;
@endphp
<html>
...
<div class="container-fluid report-header">
    ...
    <div class="row">
        <div class="pbutton">
            ...
            <a href="/{{ config('app.cp_route_name') }}/commitment/SubmitprintCommitment/{{$commitment->id}}"
        ...
        <div class="col-sm-12 text-center ">
            <div class="logo">
                @if(isset(\App\Models\FinancePartyModel::find($finance_party)->image))
                    <img src="{{asset("cp/images/".\App\Models\FinancePartyModel::find($finance_party)->image)}}"
                         class=""></div>
            @endif
        </div>
        ...
        <div class="col-sm-10 col-sm-offset-1 ">
            ...
            <table class="table table-striped table-bordered   order-column" id="">
                ...
                <tr>
                    ...
                    <td>
                        <h4 class="strong">{{($commitment->amount)?$commitment->amount.' '.(($commitment->currency)?\App\Models\TypesModel::getTypeName($commitment->currency):'NIS'):"Unlimited"}}</h4>
                    </td>
                </tr>
...
<div class="bottomPage">
    ...
    <div class="row space">
        ...
        <div class="col-sm-8  text-left">
            <i class="glyphicon glyphicon-map-marker"></i> {{\App\Models\FinancePartyModel::find($finance_party)->address}}
        </div>
        <div class="col-sm-4 text-left">
            <div class="row">

                <div class="col-sm-12">
                    <i class="glyphicon glyphicon-phone"></i>{{\App\Models\FinancePartyModel::find($finance_party)->telephone}}
                </div>
                <div class="col-sm-12">
                    <i class="glyphicon glyphicon-envelope"></i> {{\App\Models\FinancePartyModel::find($finance_party)->email}}
                </div>
