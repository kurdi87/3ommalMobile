...
@endforeach
 ...
 Form::checkbox('serv[]',$service->serv_id,(!$errors->has() && in_array($service->serv_id,$invoice_items->lists('serv_id')->toArray()))?true:null, array('class'=>'mycheckbox addserv ccheckbox',"data-parent"=>"parent".$service->serv_id)) !!}
 @else{!!
 Form::checkbox('serv[]',$service->serv_id,null, array('class'=>'mycheckbox addserv ccheckbox',"data-parent"=>"parent".$service->serv_id)) !!}
 @endif
