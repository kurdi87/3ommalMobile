        ...
        <div class="row">
            ...
            <div class="col-md-11">
                <div class="form-group input-wlbl  @if ($errors->has('subject')) has-error @endif">
                    <input type="hidden" name="commitment_id" value="{{$commitment_email->id}}">
                    {!! Form::text('subject','Commitment letter',['class'=>'form-control']) !!}
            ...
            <div class="col-md-11">
                <div class="form-group input-wlbl  @if ($errors->has('content')) has-error @endif">
                    {!! Form::textarea('content','Commitment Letter',['class'=>'form-control textarea']) !!}
