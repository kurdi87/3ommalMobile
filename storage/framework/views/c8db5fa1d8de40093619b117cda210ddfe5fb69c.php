...
<?php $__env->startSection('js'); ?>
    ...
    <script src="cp/js/city.js" type="text/javascript"></script>
                            ...
                            <form action="#" class="horizontal-form search-form">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group input-wlbl">
                                                <span class="lblinput">Country</span>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo e(config('app.cp_route_name')); ?>/city/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New City">
