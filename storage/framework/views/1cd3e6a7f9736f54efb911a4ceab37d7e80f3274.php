<?php $__env->startSection('js'); ?>
    ...
    <script src="cp/js/injuryAtt.js" type="text/javascript"></script>
    <?php if($errors->has()): ?>
        <script>
...
<?php $__env->startSection('content'); ?>
    <div class="form-package">
        <?php echo Form::model($result,['action'=>['Admin\InjuryController@update',$result->id],'class'=>'form-validation form-datavalidation']); ?>

        <?php echo $__env->make('cp.injury.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo Form::close(); ?>
            ...
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body-attach" id="div1">
                        ...
                        <?php echo $__env->make('cp.injury.addAtt', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
