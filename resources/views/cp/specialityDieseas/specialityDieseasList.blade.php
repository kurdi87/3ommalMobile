...
@section('js')
    ...
    <script src="cp/js/specialityDieseas.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">SpecialityDieseas</span>
                    </div>
                </div>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/specialityDieseas/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New SpecialityDieseas">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <button class="btn green  btn-outline dropdown-toggle" data-toggle="dropdown">specialityDieseas List
                                        <i class="fa fa-angle-down"></i>
                                    </button>
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/specialityDieseas/reprt?export=csv&amp;" href="{{ config('app.cp_route_name') }}/specialityDieseas/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/specialityDieseas/list?export=xlsx&amp;" href="{{ config('app.cp_route_name') }}/specialityDieseas/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/specialityDieseas/list?export=pdf&amp;" href="{{ config('app.cp_route_name') }}/specialityDieseas/list?export=pdf&amp;">
