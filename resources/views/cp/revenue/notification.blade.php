...
Hello {{$patient_name}},
<br>
This to  inform you that an card has been created to you
<br>
...
@elseif($type=='update')
    Hello {{$patient_name}},
    <br>
    This to  inform your card has been update to:
    <br>
    <ul style="list-style: unset">
    ...
    @elseif($type=='reminder')
        Hello {{$patient_name}},
        <br>
        This is Reminder to  inform you that an card has been created to you
        <br>
        <ul style="list-style: unset">
            <li>Patient:{{$patient}}</li>
            <li> Finance Party:{{$finance_party}}</li>
