...
@section('js')
    ...
    <script src="cp/js/invoiceForm.js" type="text/javascript"></script>
    <script src="cp/js/invoiceProcedure.js" type="text/javascript"></script>
    <script src="cp/js/invoiceAtt.js" type="text/javascript"></script>
...
@section('content')
    ...
    {!! Form::model($result,['action'=>['Admin\InvoiceController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
    @include('cp.invoice.form')
    {!! Form::close() !!}
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            </a> Click Here To Add Atts To This Invoice
