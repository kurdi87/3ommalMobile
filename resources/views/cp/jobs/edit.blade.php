...
@section('js')
    ...
    <script src="cp/js/jobsForm.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\JobsController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.jobs.form')
        {!! Form::close() !!}
