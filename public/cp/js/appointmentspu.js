...
jQuery(document).ready(function () {
    ...
    oTable = $('#mydatatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "crm/appointment/list?status="+$('#statusN').val()+"&action="+$('#actionN').val()+"&from="+$('#from').val()+"&to="+$('#to').val()+"&recipe="+$('#hospitalN').val()+"&finance_party="+$('#finance_partyN').val()+"&employee="+$('#employeeN').val(),
        "order": [[ 0, "desc" ]],
        columnDefs: [
        ...
        "fnDrawCallback": function (oSettings) {
            ...
            $(".exportData").each(function(){
                $(this).attr("href", $(this).data("href") +"status="+$('#statusN').val()+"&action="+$('#actionN').val()+"&from="+$('#from').val()+"&to="+$('#to').val()+"&recipe="+$('#hospitalN').val()+"&finance_party="+$('#finance_partyN').val()+"&employee="+$('#employeeN').val(),+"&"+ input);
            });
        },
    ...
    jQuery(document).on('change', '#status', function () {
        ...
        oTable.ajax.url("crm/appointment/list?status="+$('#statusN').val()+"&action="+$('#actionN').val()+"&from="+$('#from').val()+"&to="+$('#to').val()+"&recipe="+$('#hospitalN').val()+"&finance_party="+$('#finance_partyN').val()+"&employee="+$('#employeeN').val()).load();
    });
