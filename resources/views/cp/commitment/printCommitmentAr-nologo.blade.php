...
<div class="container report-body" dir="rtl">
    ...
    <div class="row ">
        ...
        <div class="col-sm-3">
            <div class="row">
                <div class="col-sm-7">{{$patient->fname_ar}} {{$patient->faname_ar}} </div>
    ...
    @if($commitment->accident_id)
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="row">
                    <div class="col-sm-6">{{\App\Models\TypesModel::getTypeName(\App\Models\AccidentModel::find($commitment->accident_id)->injury,2)}}</div>
            ...
            <div class="col-sm-3">
                <div class="row">
                    <div class="col-sm-6">{{\App\Models\TypesModel::getTypeName(\App\Models\AccidentModel::find($commitment->accident_id)->result,2)}}</div>
        ...
        <div class="col-sm-10 col-sm-offset-1 ">
            ...
            <table class="table table-striped table-bordered   order-column" id="">
                ...
                <tr>
                    ...
                    <td>
                        <h4 class="strong">{{($commitment->amount)?$commitment->amount.' '.\App\Models\TypesModel::getTypeName($commitment->currency):"غير محدد"}}</h4>
                    </td>
                </tr>
