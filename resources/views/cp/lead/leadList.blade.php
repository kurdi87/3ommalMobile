...
@section('js')
    ...
    <script src="cp/js/lead.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Lead</span>
                    </div>
                </div>
                <div class="portlet-body">
                            ...
                            <form action="#" class="horizontal-form search-form">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="sourceN" placeholder="" value="{{ (app()->request->type?app()->request->type:-1)}}"/>
                                                {!! Form::select('source', $source, (app()->request->type?app()->request->type:null),["class"=>"form-control ","id"=>"source"]) !!}
                                                <span class="help-block"></span>
                    ...
                    @if(in_array($role,$create))
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">

                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/lead/create"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <button class="btn green  btn-outline dropdown-toggle" data-toggle="dropdown">Lead
                                        List
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/lead/reprt?export=csv&amp;"
                                               href="{{ config('app.cp_route_name') }}/lead/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/lead/list?export=xlsx&amp;"
                                               href="{{ config('app.cp_route_name') }}/lead/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/lead/list?export=pdf&amp;"
                                               href="{{ config('app.cp_route_name') }}/lead/list?export=pdf&amp;">
        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Lead Process History</h4>
                </div>
