    ...
    <div class="row">
        <div class="col-sm-4 text-left ">
            <div class="logo">
                ...
                <img src="{{asset("cp/images/".\App\Models\FinancePartyModel::find($gop->finance_party)->image)}}" class=""></div>
                    @else
...
<div class="container-fluid myreport-footer-top footer ">
    ...
    <div class="row  ">
        ...
        <div class="col-sm-12  ">
            <strong> *This GoP Produced By Optimum Solution CRM for Medical Case Management:</strong>
        </div>
        <div class="col-sm-12  ">
