                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 hidden">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                ...
                                                <?php echo Form::select('country', $country, NULL,["class"=>"form-control select2 ","id"=>"country"]); ?>

                                                <span class="help-block"></span>
                                                <?php if($errors->has('status')): ?>
                                                    <span class="help-block error"><?php echo e($errors->first('country')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="col-md-4 hidden">
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo e(config('app.cp_route_name')); ?>/recipe/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New Recipe">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/recipe/reprt?export=csv&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/recipe/list?export=csv&amp;">
                                                    <i class="fa fa-print"></i>Export To CSV
                                                </a>
                                            </li>
                                            <li>
                                                <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/recipe/list?export=xlsx&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/recipe/list?export=xlsx&amp;">
                                                    <i class="fa fa-file-excel-o"></i>Export To Excel
                                                </a>
                                            </li>
                                            <li>
                                                <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/recipe/list?export=pdf&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/recipe/list?export=pdf&amp;">
