...
jQuery(document).ready(function () {
    ...
    oTable = $('#mydatatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "hitechjobs/address/list?hospital="+$('#hospitalN').val()+"&type="+$('#typeN').val()+"&titles="+$('#titlesN').val()+"&department="+$('#departmentN').val(),
        "order": [[0, "desc"]],
        columnDefs: [
        ...
        "fnDrawCallback": function (oSettings) {
            ...
            $(".exportData").each(function () {
                $(this).attr("href", $(this).data("href") +"hospital="+$('#hospitalN').val()+"&department="+$('#departmentN').val()+"&titles="+$('#titles').val(),+input);
            });
        },
    ...
    jQuery(document).on('click', '.processModal', function () {
        ...
        jQuery('.modal-body').load('hitechjobs/address/process/' + eid);
        return false;
    });
    ...
    jQuery(document).on('click', '.visitModal', function () {
        ...
        jQuery('#' + target).modal('show');
        jQuery('.modal-body-visit').load('hitechjobs/address/visit/' + eid);
        return false;
    });
    jQuery(document).on('submit', '#addVisit', function () {
        ...
        if (!errors) {
            jQuery.ajax({
                url: "hitechjobs/address/addVisit",
    ...
    jQuery(document).on('change', '#hospital', function () {
        ...
        oTable.ajax.url("hitechjobs/address/list?hospital="+$('#hospitalN').val()+"&titles="+$('#titlesN').val()+"&department="+$('#departmentN').val()+"&type="+$('#typeN').val()).load();
    });
