...
@section('js')
    ...
    <script src="cp/js/payment.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
                            ...
                            <form action="#" class="horizontal-form search-form">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group input-wlbl">
                                                ...
                                                <input data-column="1" type="text" class="form-control searchable"
                                                       placeholder="Name or SID or Payment No " value=""/>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="service_providerN" placeholder="" value="0"
                                                       class="filter"/>
                                                {!! Form::select('service_provider', $service_provider, NULL,["class"=>"form-control select2 ","id"=>"service_provider"]) !!}
                                                <span class="help-block"></span>
                                                @if ($errors->has('type'))
                                                    <span class="help-block error">{{ $errors->first('service_provider') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/payment/create"
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/payment/reprt?export=csv&amp;"
                                               href="{{ config('app.cp_route_name') }}/payment/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/payment/list?export=xlsx&amp;"
                                               href="{{ config('app.cp_route_name') }}/payment/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/payment/list?export=pdf&amp;"
                                               href="{{ config('app.cp_route_name') }}/payment/list?export=pdf&amp;">
        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">payment Process History</h4>
                </div>
