                        ...
                        <div class="portlet light ">
                            <div class="portlet-title tabbable-line">
                                ...
                                <ul id="tabs-settings" class="nav nav-tabs">
                                    ...
                                    <li role="tab" class="hidden">
                                        <a href="#tab_1_3 hidden" data-toggle="tab">اعدادات شبكات التواصل الاجتماعي</a>
                                    </li>
                                    <li role="tab" class="hidden">
                                ...
                                <?php echo Form::open(['action'=>'Admin\SettingController@update','class'=>'form-validation']); ?>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            <div class="input-wcheckbox-rg hidden">
                                            ...
                                            <div class="form-group hidden input-wlbl">
