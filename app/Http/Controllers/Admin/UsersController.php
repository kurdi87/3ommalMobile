...
class UsersController extends SuperAdminController
{

    public function __construct()
    {
        parent::__construct();
        parent::$data['active_menuPlus'] = "``";
        parent::$data['active_menu'] = "HR";
    ...
    public function get(Request $request)
    {
        ...
        if($request->input("export")){
            ...
            $this->exportFile("System Users Report",$table,$type,true);
        }
    ...
    public function create()
    {
        ...
        parent::$data["breadcrumbs"]["Add"]="Add";
