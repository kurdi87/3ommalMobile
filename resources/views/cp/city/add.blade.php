...
@section('js')
    ...
    <script src="cp/js/usersForm.js" type="text/javascript"></script>
        <script src="cp/js/cityForm.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::open(['action'=>'Admin\CityController@store','class'=>'form-validation form-datavalidation']) !!}
        @include('cp.city.form')
        {!! Form::close() !!}
    </div>
@stop