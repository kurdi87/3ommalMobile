...
<?php $__env->startSection('content'); ?>
    <div class="form-package">
        <?php echo Form::model($result,['action'=>[($isProfile) ? "Admin\UserController@updateProfile":"Admin\UsersController@update",$result->SysUsr_ID],'class'=>'form-validation form-datavalidation user-form', 'files' => true]); ?>

        <?php echo $__env->make('cp.users.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo Form::close(); ?>
