...
@section('js')
    ...
    <script src="cp/js/financePartyAtt.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\FinancePartyController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            </a> Click Here To Add Atts To This FinanceParty
                        </div>
                    </div>
            ...
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body-attach" id="div1">
                        ...
                        @include('cp.financeParty.addAtt')
