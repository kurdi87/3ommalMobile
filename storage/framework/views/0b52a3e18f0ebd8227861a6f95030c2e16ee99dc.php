                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="moduleN" placeholder="" value="0"
                                                       class="filter"/>
                                                <?php echo Form::select('module',$lookUp_keys,null,['class'=>'form-control select2  module ','style'=>"width: 100%","id"=>"module" ]); ?>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="btn-group">
                                    <a href="<?php echo e(config('app.cp_route_name')); ?>/lookUp/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New LookUp">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/lookUp/reprt?export=csv&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/lookUp/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/lookUp/list?export=xlsx&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/lookUp/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/lookUp/list?export=pdf&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/lookUp/list?export=pdf&amp;">
