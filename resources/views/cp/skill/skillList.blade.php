...
@section('js')
    ...
    <script src="cp/js/skill.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Skill</span>
                    </div>
                </div>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/skill/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New Skill">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <button class="btn green  btn-outline dropdown-toggle" data-toggle="dropdown">skill List
                                        <i class="fa fa-angle-down"></i>
                                    </button>
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/skill/reprt?export=csv&amp;" href="{{ config('app.cp_route_name') }}/skill/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/skill/list?export=xlsx&amp;" href="{{ config('app.cp_route_name') }}/skill/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/skill/list?export=pdf&amp;" href="{{ config('app.cp_route_name') }}/skill/list?export=pdf&amp;">
