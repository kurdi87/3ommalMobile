...
@section('js')
    ...
    <script src="cp/js/vacationAtt.js" type="text/javascript"></script>
    ...
    @if(isset($status))
        <script>
            jQuery(document).ready(function () {
                alert('ffff')
                toasterMessage('error', '{{$message}}', 'Error Message');
            });
...
@section('content')
    ...
    {!! Form::model($result,['action'=>['Admin\VacationController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            </a> Click Here To Add Atts To This Request for Vacation -إضافة مرفقات
                        </div>
                    </div>
        ...
        <div class="modal fade" id="modal-attEdit" tabindex="-1" role="basic" aria-hidden="true">
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title">Edit att - تعديلس</h4>
                    </div>
