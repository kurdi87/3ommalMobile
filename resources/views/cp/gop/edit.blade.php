...
@section('js')
    ...
    <script src="cp/js/gopForm.js" type="text/javascript"></script>

    <script src="cp/js/gopAtt.js" type="text/javascript"></script>
    <script src="cp/js/gopProcedure.js" type="text/javascript"></script>
    <script src="cp/js/gopMedication.js" type="text/javascript"></script>
...
@section('content')
    ...
    {!! Form::model($result,['action'=>['Admin\GopController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
    @include('cp.gop.form')
    {!! Form::close() !!}
                    ...
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            <a title="Add Atts" data-modal="modal-attadd"
                               ...
                               href="#">
                                <i class="fa fa-plus"> </i>
                            </a> Click Here To Add Atts To This Request for GOP - أضف مرفقات
                        </div>
                    </div>
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <tr>
                                ...
                                <th class="tblaction-rg tblaction-three-rg">Delete- حذق</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
