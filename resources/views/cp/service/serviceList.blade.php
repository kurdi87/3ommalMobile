...
@section('js')
    ...
    <script src="cp/js/service.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/service/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New Service">
