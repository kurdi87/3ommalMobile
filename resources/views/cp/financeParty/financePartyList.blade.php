...
@section('js')
    ...
    <script src="cp/js/financeParty.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">FinanceParty</span>
                    </div>
                </div>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/financeParty/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New FinanceParty">
