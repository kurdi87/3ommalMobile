<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        <!-- BEGIN LOGO -->
        <div class="page-logo">
            <a href="<?php echo e(config('app.cp_route_name')); ?>">
                <!--<img src="./cp/layouts/layout/img/logo.png" alt="logo" class="logo-default"/>-->
              
                <img src="./cp/images/logo-header.png" alt="logo" class="logo-default" style="width: 60px !important;"/>
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                       data-close-others="true">
                        <?php if(!empty(Auth::user('admin')->SysUsr_ThumbImage)): ?>
                            <img alt="" class="img-circle" src="<?php echo e(url('uploads/users/'.Auth::user('admin')->SysUsr_ThumbImage)); ?>"/>
                        <?php endif; ?>
                        <span class="username username-hide-on-mobile"> <?php echo e(Auth::user('admin')->SysUsr_FullName); ?> </span>
                        <i class="fa fa-angle-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="<?php echo e(config('app.cp_route_name')); ?>/profile/overview">
                                <i class="icon-user"></i>Profile </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo e(config('app.cp_route_name')); ?>/profile/edit?pass=pass">
                                <i class="icon-key"></i>Change Password </a>
                        </li>
                        
                        <li>
                            <a href="<?php echo e(config('app.cp_route_name')); ?>/logout">
                ...
                <li class="dropdown dropdown-quick-sidebar-toggler">
                    <a href="<?php echo e(config('app.cp_route_name')); ?>/logout" class="dropdown-toggle">
