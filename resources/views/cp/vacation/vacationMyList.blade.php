...
@section('js')
    ...
    <script src="cp/js/validation.js" type="text/javascript"></script>
    <script src="cp/js/myvacation.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Vacations -إجازات</span>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group input-wlbl">
                                                ...
                                                <input data-column="1" type="text" class="form-control searchable"
                                                       placeholder="Name or Emp Number" value=""/>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                ...
                                                {!! Form::select('type[]', $types, NULL,["class"=>"form-control select2 ","id"=>"type", "multiple"=>"multiple","data-placeholder"=>"Type"]) !!}
                                                <span class="help-block"></span>
                                                @if ($errors->has('type'))
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="btn-group">
                                    <a href="{{ config('app.cp_route_name') }}/vacation/create"
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <button class="btn green  btn-outline dropdown-toggle" data-toggle="dropdown">
                                        request for Vacation List - قائمة
                                        <i class="fa fa-angle-down"></i>
                                    </button>
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/vacation/reprt?export=csv&amp;"
                                               href="{{ config('app.cp_route_name') }}/vacation/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/vacation/list?export=xlsx&amp;"
                                               href="{{ config('app.cp_route_name') }}/vacation/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/vacation/list?export=pdf&amp;"
                                               href="{{ config('app.cp_route_name') }}/vacation/list?export=pdf&amp;">
        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">request for Vacation Process History - سجل</h4>
                </div>
    ...
    <div class="modal fade" id="modal-action" tabindex="-1" role="basic" aria-hidden="true">
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Change Action</h4>
                </div>
