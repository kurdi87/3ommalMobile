        ...
        <div class="row">
            ...
            <div class="col-md-11">
                <div class="form-group input-wlbl  @if ($errors->has('subject')) has-error @endif">
                    <input type="hidden" name="event_id" value="{{$event_email->id}}">
                    {!! Form::text('subject','Referral Form',['class'=>'form-control']) !!}
            ...
            <div class="col-md-11">
                <div class="form-group input-wlbl  @if ($errors->has('content')) has-error @endif">
                    {!! Form::textarea('content','Referral Form',['class'=>'form-control textarea']) !!}
