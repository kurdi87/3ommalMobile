                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="moduleN" placeholder="" value="0"
                                                       class="filter"/>
                                                {!! Form::select('module',$modules,null,['class'=>'form-control select2  module ','style'=>"width: 100%","id"=>"module" ]) !!}
                                                <span class="help-block"></span>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="btn-group">
                                    <a href="{{ config('app.cp_route_name') }}/types/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New Types">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/types/reprt?export=csv&amp;" href="{{ config('app.cp_route_name') }}/types/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/types/list?export=xlsx&amp;" href="{{ config('app.cp_route_name') }}/types/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="{{ config('app.cp_route_name') }}/types/list?export=pdf&amp;" href="{{ config('app.cp_route_name') }}/types/list?export=pdf&amp;">
