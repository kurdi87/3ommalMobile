...
@section('js')
    ...
    <script src="cp/js/address.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group input-wlbl">
                                                ...
                                                <input data-column="1" type="text" class="form-control searchable" placeholder="Name ,email, telephone,mobile or note" value=""/>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="titlesN" placeholder="" value="0" class="filter"/>
                                                {!! Form::select('titles', $titles, NULL,["class"=>"form-control select2 ","id"=>"titles"]) !!}
                                                <span class="help-block"></span>
                                                @if ($errors->has('status'))
                                                    <span class="help-block error">{{ $errors->first('titles') }}</span>
                                                @endif
                                            </div>
                                        </div>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/address/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New Address">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/address/reprt?export=csv&amp;"
                                               href="{{ config('app.cp_route_name') }}/address/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/address/list?export=xlsx&amp;"
                                               href="{{ config('app.cp_route_name') }}/address/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/address/list?export=pdf&amp;"
                                               href="{{ config('app.cp_route_name') }}/address/list?export=pdf&amp;">
