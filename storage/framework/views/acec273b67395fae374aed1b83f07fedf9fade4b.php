                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group input-wlbl  <?php if($errors->has('title')): ?> has-error <?php endif; ?>">
                                                <span class="lblinput"> العنوان</span>
                                                 <?php echo Form::text('injury_id',isset($result->id)?$result->id:"0",['class'=>'hidden injury_id txtinput-required']); ?>
            ...
            <div class="upload-injury-att">
               
                 <?php echo Form::text('name','1.jpg',['class'=>'hidden from-control  icon ']); ?>

               
                <input type="file" name="image" class="  upload-injury-att" id="0" accept="*/*" />
