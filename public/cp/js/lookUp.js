...
jQuery(document).ready(function () {
    ...
    oTable = $('#mydatatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "crm/lookUp/list?status="+$('#statusN').val()+"&module="+$('#moduleN').val(),
        "order": [[ 1, "desc" ]],
        columnDefs: [
        ...
        "columns": [
            {data: 'id', name: 'id'},
            {data: 'lookUp_key', name: 'lookUp_key'},
            {data: 'lookUp', name: 'lookUp'},
            {data: 'lookUp_ar', name: 'lookUp_ar'},
        ...
        "fnDrawCallback": function (oSettings) {
            ...
            $(".exportData").each(function(){
                $(this).attr("href",$(this).data("href")+"status="+$('#statusN').val()+"&module="+$('#moduleN').val()+input);
            });
        },
    ...
    jQuery(document).on('change', '#status', function () {
        ...
        oTable.ajax.url("crm/lookUp/list?status="+$('#statusN').val()+"&module="+$('#moduleN').val()).load();
    });
