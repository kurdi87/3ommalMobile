...
@section('js')
    ...
    <script src="cp/js/addressForm.js" type="text/javascript"></script>

    <script src="cp/js/addressAtt.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\AddressController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.address.form')
        {!! Form::close() !!}
    </div>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            ...
                            </a> Click Here To Add Atts To This Address
                        </div>
                    </div>
