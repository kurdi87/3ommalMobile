...
var reportAttar = function () {
    ...
    var handleAjaxReport = function() {
        ...
        jQuery.ajax({
            type: 'GET',
            url: 'http://dcetest.com/new_attar/public/cp-attar/numberBlogs',
            data: {
                groupBy: group_by,
                from: date_from,
                to: date_to
            ...
            success: function (data) {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    yaxies.push(parseFloat(result[i].articlesNo));
                }
                //console.log(result);
                if(result.length)
                {
