jQuery(document).ready(function () {
    ...
    oTable = $('#mydatatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "crm/claim/list?status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+"&hospital=" + $('#hospital').val()+"&branch=" +  encodeURIComponent($('#branch').val())+ "&finance_party=" + $('#finance_party').val()+ "&beneficiary=" + $('#beneficiary').val()+ "&employee=" + $('#employee').val()+ "&service_type=" + $('#service_type').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val(),
        "order": [[0, "desc"]],
        columnDefs: [
        ...
        "fnDrawCallback": function (oSettings) {
            ...
            $(".exportData").each(function () {
                $(this).attr("href", $(this).data("href") + "status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+ "&hospital=" + $('#hospital').val() + "&finance_party=" + $('#finance_party').val()+ "&beneficiary=" + $('#beneficiary').val()+ "&employee=" + $('#employee').val()+ "&service_type=" + $('#service_type').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val() + "&" + input);
            });
        },
    ...
    jQuery(document).on('click', '.btn-submit-search', function () {
        oTable.ajax.url("crm/claim/list?status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+"&finance_party=" + $('#finance_party').val()+ "&beneficiary=" + $('#beneficiary').val()+ "&employee=" + $('#employee').val()+ "&service_type=" + $('#service_type').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val()).load();
    });
    jQuery(document).on('change', '#status', function () {
        var status = $('#statusN').attr('value', this.value);
        oTable.ajax.url("crm/claim/list?status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+"&hospital=" + $('#hospital').val()+"&branch=" +  encodeURIComponent($('#branch').val())+ "&finance_party=" + $('#finance_party').val()+ "&beneficiary=" + $('#beneficiary').val()+ "&employee=" + $('#employee').val()+ "&service_type=" + $('#service_type').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val()).load();
    });
    ...
    jQuery(document).on('change', '#beneficiary', function () {
        var action = $('#beneficiaryN').attr('value', this.value);
        oTable.ajax.url("crm/claim/list?status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+"&hospital=" + $('#hospital').val()+"&branch=" +  encodeURIComponent($('#branch').val())+  "&finance_party=" + $('#finance_party').val()+ "&beneficiary=" + $('#beneficiary').val()+ "&employee=" + $('#employee').val()+ "&service_type=" + $('#service_type').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val()).load();
    });
    ...
    jQuery(document).on('change', '#service_type', function () {
        var action = $('#service_typeN').attr('value', this.value);
        oTable.ajax.url("crm/claim/list?status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+"&hospital=" + $('#hospital').val()+"&branch=" +  encodeURIComponent($('#branch').val())+  "&finance_party=" + $('#finance_party').val()+ "&beneficiary=" + $('#beneficiary').val()+ "&employee=" + $('#employee').val()+ "&service_type=" + $('#service_type').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val()).load();
    });
    jQuery(document).on('change', '#issubmit', function () {
        var action = $('#issubmitN').attr('value', this.value);
        oTable.ajax.url("crm/claim/list?status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+"&hospital=" + $('#hospital').val()+"&branch=" +  encodeURIComponent($('#branch').val())+ "&finance_party=" + $('#finance_party').val()+ "&beneficiary=" + $('#beneficiary').val()+ "&employee=" + $('#employee').val()+ "&service_type=" + $('#service_type').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val()).load();
    });
    ...
    jQuery(document).on('change', '#branch', function () {
        var action = $('#branchN').attr('value', this.value);
        oTable.ajax.url("crm/claim/list?status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+"&hospital=" + $('#hospital').val()+"&branch=" +  encodeURIComponent($('#branch').val())+ "&finance_party=" + $('#finance_party').val()+ "&beneficiary=" + $('#beneficiary').val()+ "&employee=" + $('#employee').val()+ "&service_type=" + $('#service_type').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val()).load();
    });
    ...
    jQuery(document).on('click', '.btn-reset', function () {
        $('.form-control').val('');
        oTable.ajax.url("crm/claim/list?status=" + $('#status').val() + "&issubmit=" + $('#issubmit').val()+"&action=" + $('#action').val() + "&from=" + $('#from').val() + "&to=" + $('#to').val()).load();
    });
    ...
    jQuery(document).on('change', '#status', function () {
        var status = $('#statusN').attr('value', this.value);
        oTable.ajax.url('crm/claim/list?status=' + this.value).load();
    });
    ...
    jQuery(document).on('click', '.processModal', function () {
        ...
        jQuery('.modal-body').load('crm/claim/process/' + eid);
        return false;
    });
    jQuery(document).on('click', 'body', function (e) {
        var target = $(e.target);
    ...
    jQuery(document).on('click', '.cstatusModal', function () {
        ...
        jQuery('#' + target).modal('show');
        jQuery('.modal-body-cstatus').load('crm/claim/cstatus/' + eid);
        return false;
    });
