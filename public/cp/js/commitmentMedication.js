...
jQuery(document).ready(function () {
    ...
    otable7 = $('#mydatatable7').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "crm/commitment/listMedication/"+commitment_id,
        "order": [[ 1, "desc" ]],
        columnDefs: [
    ...
    jQuery(document).on('click', '.medEditmodal', function () {
        ...
        var target = jQuery(this).attr('data-modal');
        jQuery('#' + target).modal('show');
        jQuery('.modal-body').load('crm/commitment/editMed/'+medid);
        return false;
    });
        ...
        if (confirm("This will delete item...Are you sure?"))
        {
            jQuery.ajax({
                ...
                success: function (data) {
                    ...
                    if (thisclick.hasClass('mmstatus-active')) {

                        thisclick.removeClass('mmstatus-active').addClass('mmstatus-inactive');
                     ...
                     //   thisclick.tooltipster('content', 'Activate');
                        ...
                        thisclick.removeClass('mmstatus-inactive').addClass('mmstatus-active');
