...
<?php $__env->startSection('js'); ?>
    ...
    <script src="cp/js/CategorySub.js" type="text/javascript"></script>
...
<?php $__env->startSection('content'); ?>
    <div class="form-package">
        <?php echo Form::model($result,['action'=>['Admin\CategoryController@update',$result->id],'class'=>'form-validation form-datavalidation']); ?>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <a title="Add Sub Category" data-modal="modal-subadd" class="submodal btn btn-circle btn-icon-only btn-default tooltip-one-info" data-id=""   href="#">
                        <i class="fa fa-plus"> </i>
                    </a> Click Here To Add Sub Category
                </div>
            </div>
            <div class="portlet-body">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="mydatatable1">
                    <thead>
                    <tr>
                        <th>ID - رقم</th>
                        <th>Name - اسم</th>
...
<div class="modal fade" id="modal-subadd" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            ...
            <?php echo Form::open(["id"=>"addSub","class"=>"form-validation "]); ?>

            <div class="modal-body-attach" >

                <?php echo $__env->make('cp.category.addSub', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<div class="modal fade" id="modal-subEdit" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            ...
            <?php echo Form::open(["id"=>"editSub","class"=>"form-validation "]); ?>
