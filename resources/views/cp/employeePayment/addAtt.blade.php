                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group input-wlbl  @if ($errors->has('title')) has-error @endif">
                                                <span class="lblinput">Title</span>
                                                 {!! Form::text('employeePayment_id',isset($result->id)?$result->id:"0",['class'=>'hidden employeePayment_id txtinput-required']) !!}
                                           ...
                                           <div class="col-md-12">
                                            ...
                                            <div class="form-group input-wlbl  @if ($errors->has('icon')) has-error @endif">
                                                 <span class=" ">employeePayment  Attachment </span>
            ...
            <div class="upload-employeePayment-att">
               
                 {!! Form::text('name','1.jpg',['class'=>'hidden from-control  icon ']) !!}
               
                <input type="file" name="image" class="  upload-employeePayment-att" id="0" accept="*/*" />
