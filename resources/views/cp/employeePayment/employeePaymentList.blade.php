...
@section('js')
    ...
    <script src="cp/js/employeePayment.js" type="text/javascript"></script>
    @if(isset($success))
        <script>
...
@section('content')
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">employeePayment</span>
                    </div>
                </div>
                            ...
                            <form action="#" class="horizontal-form search-form">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group input-wlbl">
                                                ...
                                                <input data-column="1" type="text" class="form-control searchable"
                                                       placeholder="Name or SID or EmployeePayment No " value=""/>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="projectN" placeholder="" value="0"
                                                       class="filter"/>
                                                {!! Form::select('project', $project, NULL,["class"=>"form-control select2 ","id"=>"project"]) !!}
                                                <span class="help-block"></span>
                                                @if ($errors->has('type'))
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="monthN" placeholder="" value="0"
                                                       class="filter"/>
                                                {!! Form::select('month', $month, NULL,["class"=>"form-control select2 ","id"=>"month"]) !!}
                                                <span class="help-block"></span>
                                                @if ($errors->has('type'))
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="yearN" placeholder="" value="0"
                                                       class="filter"/>
                                                {!! Form::select('year', $year, NULL,["class"=>"form-control select2 ","id"=>"year"]) !!}
                                                <span class="help-block"></span>
                                                @if ($errors->has('type'))
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/employeePayment/create"
                                           class="btn btn-circle btn-icon-only btn-default tooltip-one-info"
                                           title="New employeePayment">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/employeePayment/reprt?export=csv&amp;"
                                               href="{{ config('app.cp_route_name') }}/employeePayment/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/employeePayment/list?export=xlsx&amp;"
                                               href="{{ config('app.cp_route_name') }}/employeePayment/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/employeePayment/list?export=pdf&amp;"
                                               href="{{ config('app.cp_route_name') }}/employeePayment/list?export=pdf&amp;">
        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">employeePayment Process History</h4>
                </div>
    ...
    <div class="modal fade" id="modal-cstatus" tabindex="-1" role="basic" aria-hidden="true">
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button status="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
