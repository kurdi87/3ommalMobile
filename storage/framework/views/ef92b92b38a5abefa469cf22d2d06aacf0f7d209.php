...
<?php $__env->startSection('js'); ?>
    ...
    <script src="cp/js/types.js" type="text/javascript"></script>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase">Types</span>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="statusN" placeholder="" value="0"
                                                       class="filter"/>
                                                <?php echo Form::select('status', $status, NULL,["class"=>"form-control select2 ","id"=>"status"]); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                <input type="hidden" id="moduleN" placeholder="" value="0"
                                                       class="filter"/>
                                                <?php echo Form::select('module',$modules,null,['class'=>'form-control select2  module ','style'=>"width: 100%","id"=>"module" ]); ?>

                                                <span class="help-block"></span>
                                                <?php if($errors->has('module')): ?>
                                                    <span class="help-block error"><?php echo e($errors->first('module')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="btn-group">
                                    <a href="<?php echo e(config('app.cp_route_name')); ?>/types/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New Types">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <button class="btn green  btn-outline dropdown-toggle" data-toggle="dropdown">types List
                                        <i class="fa fa-angle-down"></i>
                                    </button>
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/types/reprt?export=csv&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/types/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/types/list?export=xlsx&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/types/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/types/list?export=pdf&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/types/list?export=pdf&amp;">
