...
@section('js')
    ...
    <script src="cp/js/usersForm.js" type="text/javascript"></script>
     <script src="cp/js/claimForm.js" type="text/javascript"></script>

          <script src="cp/js/claimAtt.js" type="text/javascript"></script>
    <script src="cp/js/claimProcedure.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\ClaimController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.claim.form')
        {!! Form::close() !!}
                    ...
                    <div class="caption font-dark">
                        ...
                        <div class="btn-group">
                         ...
                         <a title="Add Atts" data-modal="modal-attadd" class="attmodal btn btn-circle btn-icon-only btn-default tooltip-one-info" data-id=""   href="#">
                                                ...
                                                </a> Click Here To Add Atts To This claim
                    </div>
                </div>
