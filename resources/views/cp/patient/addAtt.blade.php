                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group input-wlbl  @if ($errors->has('title')) has-error @endif">
                                                <span class=""> Title</span>
                                                 {!! Form::text('patient_id',isset($result->id)?$result->id:"0",['class'=>' patient_id  hidden id txtinput-required']) !!}
                                           ...
                                           <div class="col-md-12">
                                            ...
                                            <div class="form-group input-wlbl  @if ($errors->has('icon')) has-error @endif">
                                                 <span class=" ">Patient  Attachment </span>
            ...
            <div class="upload-patient-att">
               
                 {!! Form::text('name','1.jpg',['class'=>'hidden from-control  icon ']) !!}
               
                <input type="file" name="image" class="  upload-patient-att" id="0" accept="*/*" />
