...
@section('js')
    ...
    <script src="cp/js/usersForm.js" type="text/javascript"></script>
     <script src="cp/js/leadForm.js" type="text/javascript"></script>
    <script src="cp/js/leadProcedure.js" type="text/javascript"></script>

          <script src="cp/js/leadAtt.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\LeadController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.lead.form')
        {!! Form::close() !!}
                    ...
                    <div class="caption font-dark">
                        ...
                        <div class="btn-group">
                         ...
                         <a title="Add Atts" data-modal="modal-attadd" class="attmodal btn btn-circle btn-icon-only btn-default tooltip-one-info" data-id=""   href="#">
                                                   <i class="fa fa-plus"> </i>
                                                </a> Click Here To Add Atts To This Lead
                    </div>
                </div>
                <div class="portlet-body">
