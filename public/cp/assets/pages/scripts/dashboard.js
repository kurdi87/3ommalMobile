    ...
    return {
        ...
        initJQVMAP: function() {
            ...
            jQuery(document).on('change', '.users', function () {
                window.location='crm?SysUsr_ID=' + this.value
            });
            jQuery(document).on('change', '.usersf', function () {
                window.location='crm/dashboard/finance?SysUsr_ID=' + this.value
            });
        ...
        initCalendar: function() {
            ...
            var user_id=  $('#SysUsr_ID :selected').attr('value');
            ...
            $('#calendar').fullCalendar({ //re-initialize the calendar
                ...
                editable: true,
                events: {
                    url: 'crm/appointment/event?user_id='+user_id,
        ...
        initCharts: function() {
            ...
            if ($('#site_activities').size() != 0) {
                ...
                var data1 =[];
                $.ajax({
                    url:"crm/invoice/getMonth?yaer=2018",
                    type:"post",
