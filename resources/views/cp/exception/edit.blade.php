...
<script src="cp/assets/global/scripts/datatable.js" type="text/javascript"></script>
    ...
    <script src="cp/js/usersForm.js" type="text/javascript"></script>
     <script src="cp/js/exceptionForm.js" type="text/javascript"></script>
      <script src="cp/js/exceptionDepartment.js" type="text/javascript"></script>
       <script src="cp/js/exceptionProcedure.js" type="text/javascript"></script>
          <script src="cp/js/exceptionAtt.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\ExceptionController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.exception.form')
        {!! Form::close() !!}
                ...
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <div class="btn-group">
                         ...
                         <a title="Add Department" data-modal="modal-deptadd" class="deptmodal btn btn-circle btn-icon-only btn-default tooltip-one-info" data-id=""   href="#">
                                                   <i class="fa fa-plus"> </i>
                                                </a> Click Here To Add Department - أضف قسم
                    </div>
                </div>
        ...
        <div class="modal fade" id="modal-deptEdit" role="basic" aria-hidden="true">
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                     <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title">Edit Department - تعديل قسم</h4>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="portlet box default">
                        <div class="portlet-title ">
                            <div class="caption">
                                Procedure Information - معلومات الإجراءات
                            </div>
                            <div class="tools">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                                ...
                                                <tr>
                                                    <th>ID -رقم</th>
                                                    <th>Name - اسم</th>
                                                    <th>Service Code - الكود</th>
                                                    <th>Cost - التكلفة</th>
                                                    <th>Qty - الكمية</th>
                                                    <th>Total cost NIS - المجموع شيقل</th>
                                                    <th>Status -الحالة</th>
                                                ...
                                                <tfoot>
                                                <tr>
                                                    <th colspan="4"><h4 class="text text-danger">Total Cost -المجموع :</h4></th>
                                                    <th></th>
                                                </tr>
            ...
            <div class="modal fade" id="modal-proadd" role="basic" aria-hidden="true">
                <div class="modal-dialog  modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title">Add Procedure - إضافة أجراء</h4>
                        </div>
                        {!! Form::open(["id"=>"addPro","class"=>"form-validation "]) !!}
                        <div class="modal-body-attach" id="div1">

                            @include('cp.exception.addPro')
            ...
            <div class="modal fade" id="modal-proEdit" role="basic" aria-hidden="true">
                <div class="modal-dialog  modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            <h4 class="modal-title">Edit Procedure - تعديل</h4>
                        </div>
                    ...
                    <div class="caption font-dark">
                        ...
                        <div class="btn-group">
                         ...
                         <a title="Add Atts" data-modal="modal-attadd" class="attmodal btn btn-circle btn-icon-only btn-default tooltip-one-info" data-id=""   href="#">
                                                   <i class="fa fa-plus"> </i>
                                                </a> Click Here To Add Atts - مرفقات
                    </div>
                </div>
                <div class="portlet-body">
