                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group input-wlbl  @if ($errors->has('title')) has-error @endif">
                                                <span class="lblinput">Title</span>
                                                 {!! Form::text('lead_id',isset($result->id)?$result->id:"0",['class'=>'hidden lead_id txtinput-required']) !!}
                                           ...
                                           <div class="col-md-12">
                                            ...
                                            <div class="form-group input-wlbl  @if ($errors->has('icon')) has-error @endif">
                                                 <span class=" ">Lead  Attachment </span>
            ...
            <div class="upload-lead-att">
               
                 {!! Form::text('name','1.jpg',['class'=>'hidden from-control  icon ']) !!}
               
                <input type="file" name="image" class="  upload-lead-att" id="0" accept="*/*" />
