        ...
        <div class="tabbable-line boxless tabbable-reversed">
            <div class="form-top tabbable-line clearfix">
                <div class="actions">
                    ...
                    <a href="<?php echo e(config('app.cp_route_name')); ?>/salary"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group input-wlbl  <?php if($errors->has('message')): ?> has-error <?php endif; ?>">
                                                    ...
                                                    <?php if($result->salary_paper_month==1): ?>
                                                        <button type="button" class="btn btn-success">نعم</button>
                                                    <?php else: ?>
                                                        <button type="button" class="btn btn-danger">لا يوجد</button>
                                                    <?php endif; ?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group input-wlbl <?php if($errors->has('salary_amount')): ?> has-error <?php endif; ?>">
                                                    <span class=""> مبلغ قسيمة الراتب (تلوش) خلال فترة العمل </span>

                                                    <div class="input-group">
                                                        <?php echo Form::text('salary_amount',$result->salary_amount,['class'=>'form-control  txtinput-number','readonly']); ?>
                                                    ...
                                                    <?php if($errors->has('salary_amount')): ?>
                                                        <span class="help-block error"><?php echo e($errors->first('salary_amount')); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="clearfix">
                                                ...
                                                <div class="form-group input-wlbl  <?php if($errors->has('message')): ?> has-error <?php endif; ?>">
                                                    ...
                                                    <div class="input-group input-xlarge date-picker input-daterange select2-wlbl selectrole-rg"
                                                        ...
                                                        <input type="text" id="from" class="form-control " name="from"
                                                               value="<?php echo e(Date("Y-m-d",strtotime($result->start_work_date))); ?>"
                                                               placeholder="Date form">
                                                        <span class="input-group-addon"> إلى </span>
                                                        <input type="text" id="to" class="form-control" name="to"
                                                               value="<?php echo e(Date("Y-m-d",strtotime($result->end_work_date))); ?>"
                                                               placeholder="Date to">
                                                    </div>
                                                </div>
                                            </div>
