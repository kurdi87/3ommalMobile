...
@section('js')
    ...
    <script src="cp/js/question.js" type="text/javascript"></script>
    @if(isset($success))
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/question/create"
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/question/reprt?export=csv&amp;"
                                               href="{{ config('app.cp_route_name') }}/question/list?export=csv&amp;">
                                                <i class="fa fa-print"></i>Export To CSV
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/question/list?export=xlsx&amp;"
                                               href="{{ config('app.cp_route_name') }}/question/list?export=xlsx&amp;">
                                                <i class="fa fa-file-excel-o"></i>Export To Excel
                                            </a>
                                        </li>
                                        <li>
                                            <a class="exportData"
                                               data-href="{{ config('app.cp_route_name') }}/question/list?export=pdf&amp;"
                                               href="{{ config('app.cp_route_name') }}/question/list?export=pdf&amp;">
        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Question Process History</h4>
                </div>
