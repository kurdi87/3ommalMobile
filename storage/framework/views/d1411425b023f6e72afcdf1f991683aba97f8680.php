...
<head>
    ...
    <link href="cp/assets/pages/css/login-5.min.css" rel="stylesheet" type="text/css"/>
...
<div class="user-login-5">
    <div class="row bs-reset">
        <div class="col-md-6 bs-reset mt-login-5-bsfix">
            <div class="login-bg" style="background-image:url(cp/assets/pages/img/login/bg1.jpg)">
                </div>
            </div>
            <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                <div class="login-content">
                    <img class="login-logo" src="cp/assets/pages/img/login/logo.png" />  <h1>الدخول إلى عمال</h1>
                    <p>لوحة التحكم</p>
                    <?php echo Form::open(['action'=>'Admin\LoginController@check','class'=>'login-form']); ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="alert alert-danger <?php echo e((isset($error))?"":"display-hide"); ?>">
                                <button class="close" data-close="alert"></button>
                                <span> <?php echo e(isset($error) ? $error : "Enter any username and password. "); ?></span>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <?php echo Form::text('SysUsr_UserName',null,['dir'=>'ltr','class'=>'form-control form-control-solid placeholder-no-fix form-group','autocomplete'=>'off','placeholder'=>'User Name']); ?>

                        </div>
                        <div class="col-xs-6">
                            <?php echo Form::password('SysUsr_Password',['dir'=>'ltr','class'=>'form-control form-control-solid placeholder-no-fix form-group','autocomplete'=>'off','placeholder'=>'Password']); ?>
                    ...
                    <form class=" hidden forget-form" action="javascript:;" method="post">
                ...
                <div class="login-footer ">
                    <div class="row bs-reset">
                        <div class="col-xs-5 bs-reset hidden">
                        ...
                        <div class="col-xs-7 bs-reset">
                            <div class="login-copyright text-right">
                                <p>Copyright &copy; 3ommal 2020</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="cp/assets/global/plugins/jquery-validation/js/additional-methods.min.js"
            type="text/javascript"></script>
    <script src="cp/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
    <script src="cp/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL PLUGINS -->
    <!-- BEGIN THEME GLOBAL SCRIPTS -->
    <script src="cp/assets/global/scripts/app.min.js" type="text/javascript"></script>
    <!-- END THEME GLOBAL SCRIPTS -->
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
    <script src="cp/assets/pages/scripts/login-5.js" type="text/javascript"></script>
