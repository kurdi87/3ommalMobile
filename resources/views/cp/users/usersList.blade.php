                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ config('app.cp_route_name') }}/user/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New User">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group pull-right">
                                        <button class="btn green  btn-outline dropdown-toggle" data-toggle="dropdown"> المستخدمين
                                            <i class="fa fa-angle-down"></i>
                                        </button>
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <a class="exportData" data-href="{{ config('app.cp_route_name') }}/user/reprt?export=csv&amp;" href="{{ config('app.cp_route_name') }}/user/list?export=csv&amp;">
                                                    <i class="fa fa-print"></i>Export To CSV
                                                </a>
                                            </li>
                                            <li>
                                                <a class="exportData" data-href="{{ config('app.cp_route_name') }}/user/list?export=xlsx&amp;" href="{{ config('app.cp_route_name') }}/user/list?export=xlsx&amp;">
                                                    <i class="fa fa-file-excel-o"></i>Export To Excel
                                                </a>
                                            </li>
                                            <li>
                                                <a class="exportData" data-href="{{ config('app.cp_route_name') }}/user/list?export=pdf&amp;" href="{{ config('app.cp_route_name') }}/user/list?export=pdf&amp;">
        ...
        <div class="modal fade" id="modal-changepassword" tabindex="-1" role="basic" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    {!! Form::open(["id"=>"form-changePassword","class"=>"form-validation"]) !!}
