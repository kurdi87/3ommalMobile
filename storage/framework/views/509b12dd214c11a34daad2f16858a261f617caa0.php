...
<?php $__env->startSection('js'); ?>
    ...
    <script src="cp/js/job.js" type="text/javascript"></script>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                ...
                                                <input type="hidden" id="statusN" placeholder=""
                                                       value="<?php echo e((app()->request->status?app()->request->status:0)); ?>"/>
                                                <?php echo Form::select('status', $status, (app()->request->status?app()->request->status:null),["class"=>"form-control ","id"=>"status"]); ?>

                                                <span class="help-block"></span>
                                                <?php if($errors->has('status')): ?>
                                                    <span class="help-block error"><?php echo e($errors->first('status')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                ...
                                                <?php echo Form::select('city', $city, NULL,["class"=>"form-control select2 city","id"=>"city"]); ?>

                                                <span class="help-block"></span>
                                                <?php if($errors->has('city')): ?>
                                                    <span class="help-block error"><?php echo e($errors->first('city')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                ...
                                                <input type="hidden" id="categoryN" placeholder="" value="0"/>
                                                <?php echo Form::select('category', $category, NULL,["class"=>"form-control select2 city","id"=>"category"]); ?>

                                                <span class="help-block"></span>
                                                <?php if($errors->has('category')): ?>
                                                    <span class="help-block error"><?php echo e($errors->first('category')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                ...
                                                <?php echo Form::select('user_id', $users, NULL,["class"=>"form-control select2","id"=>"user_id"]); ?>

                                                <span class="help-block"></span>
                                                <?php if($errors->has('user_id')): ?>
                                                    <span class="help-block error"><?php echo e($errors->first('user_id')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group pull-right">
                                        <button class="btn green  btn-outline dropdown-toggle" data-toggle="dropdown"> الطلبات
                                            <i class="fa fa-angle-down"></i>
                                        </button>
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/job/reprt?export=csv&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/job/list?export=csv&amp;">
                                                    <i class="fa fa-print"></i>Export To CSV
                                                </a>
                                            </li>
                                            <li>
                                                <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/job/list?export=xlsx&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/job/list?export=xlsx&amp;">
                                                    <i class="fa fa-file-excel-o"></i>Export To Excel
                                                </a>
                                            </li>
                                            <li>
                                                <a class="exportData" data-href="<?php echo e(config('app.cp_route_name')); ?>/job/list?export=pdf&amp;" href="<?php echo e(config('app.cp_route_name')); ?>/job/list?export=pdf&amp;">
