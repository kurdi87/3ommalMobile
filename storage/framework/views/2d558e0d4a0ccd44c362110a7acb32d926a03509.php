...
<?php $__env->startSection('content'); ?>
    <div class="form-package">
        <?php echo Form::model($result,['action'=>['Admin\SalaryController@update',$result->id],'class'=>'form-validation form-datavalidation']); ?>

        <?php echo $__env->make('cp.salary.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo Form::close(); ?>
            ...
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body-attach" id="div1">
                        ...
                        <?php echo $__env->make('cp.salary.addAtt', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
