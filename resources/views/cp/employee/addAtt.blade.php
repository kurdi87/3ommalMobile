                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group input-wlbl  @if ($errors->has('title')) has-error @endif">
                                                <span class="lblinput">Title - العنوان</span>
                                                 {!! Form::text('employee_id',isset($result->id)?$result->id:"0",['class'=>'hidden employee_id txtinput-required']) !!}
                                             ...
                                             <div class="col-md-6">
                                                 <div class="form-group input-wlbl  @if ($errors->has('type')) has-error @endif">
                                                     <span class="lblinput">Attachment Type - نوع</span>
                                           ...
                                           <div class="col-md-12">
                                            ...
                                            <div class="form-group input-wlbl  @if ($errors->has('icon')) has-error @endif">
                                                 <span class=" ">employee  Attachment </span>
            ...
            <div class="upload-employee-att">
               
                 {!! Form::text('name','1.jpg',['class'=>'hidden from-control  icon ']) !!}
               
                <input type="file" name="image" class="  upload-employee-att" id="0" accept="*/*" />
