                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group input-wlbl  <?php if($errors->has('title')): ?> has-error <?php endif; ?>">
                                                <span class="lblinput"> العنوان</span>
                                                 <?php echo Form::text('salary_id',isset($result->id)?$result->id:"0",['class'=>'hidden salary_id txtinput-required']); ?>
            ...
            <div class="upload-salary-att">
               
                 <?php echo Form::text('name','1.jpg',['class'=>'hidden from-control  icon ']); ?>

               
                <input type="file" name="image" class="  upload-salary-att" id="0" accept="*/*" />
