                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group select2-wlbl selectrole-rg">
                                                ...
                                                {!! Form::select('category', $category, NULL,["class"=>"form-control select2 city","id"=>"category"]) !!}
                                                <span class="help-block"></span>
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group pull-right">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <a class="exportData" data-href="{{ config('app.cp_route_name') }}/job/reprt?export=csv&amp;" href="{{ config('app.cp_route_name') }}/job/list?export=csv&amp;">
                                                    <i class="fa fa-print"></i>Export To CSV
                                                </a>
                                            </li>
                                            <li>
                                                <a class="exportData" data-href="{{ config('app.cp_route_name') }}/job/list?export=xlsx&amp;" href="{{ config('app.cp_route_name') }}/job/list?export=xlsx&amp;">
                                                    <i class="fa fa-file-excel-o"></i>Export To Excel
                                                </a>
                                            </li>
                                            <li>
                                                <a class="exportData" data-href="{{ config('app.cp_route_name') }}/job/list?export=pdf&amp;" href="{{ config('app.cp_route_name') }}/job/list?export=pdf&amp;">
