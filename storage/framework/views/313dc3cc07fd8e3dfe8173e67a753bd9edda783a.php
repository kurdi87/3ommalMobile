...
<?php $__env->startSection('js'); ?>
    ...
    <script src="cp/js/country.js" type="text/javascript"></script>
                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        <a href="<?php echo e(config('app.cp_route_name')); ?>/country/create" class="btn btn-circle btn-icon-only btn-default tooltip-one-info" title="New Country">
