...
@section('js')
    ...
    <script src="cp/js/usersForm.js" type="text/javascript"></script>
     <script src="cp/js/employeePaymentForm.js" type="text/javascript"></script>

          <script src="cp/js/employeePaymentAtt.js" type="text/javascript"></script>
    <script src="cp/js/employeePaymentProcedure.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\EmployeePaymentController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.employeePayment.form')
        {!! Form::close() !!}
                    ...
                    <div class="caption font-dark">
                        ...
                        <div class="btn-group">
                         ...
                         <a title="Add Atts" data-modal="modal-attadd" class="attmodal btn btn-circle btn-icon-only btn-default tooltip-one-info" data-id=""   href="#">
                                                ...
                                                </a> Click Here To Add Atts To This employeePayment
                    </div>
                </div>
                ...
                <div class="modal-content">
                 ...
                 {!! Form::open(["id"=>"addAtt","class"=>"form-validation "]) !!}
                    <div class="modal-body-attach" id="div1">
                         ...
                         @include('cp.employeePayment.addAtt')
