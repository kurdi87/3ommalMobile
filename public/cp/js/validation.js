 ...
 jQuery(document).ready(function() {
    ...
    //jQuery('[data-toggle="tooltip"]').tooltip('show');
     jQuery(document).on('keypress', '.arabic', function (event) {
         ...
         if (event.keyCode == 8 || event.keyCode == 37 || event.keyCode == 39 || arabicAlphabetDigits.test(event.key)) {
             return true;
         }
         else
         return false;
     ...
     jQuery(document).on('paste', '.arabic', function (event) {
