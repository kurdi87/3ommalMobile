...
jQuery(document).ready(function () {
   // users.init();
    ...
    oTable = $('#mydatatable').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "hitechjobs/city/list?country=" + $('#countryN').val() ,
        "order": [[ 1, "desc" ]],
        columnDefs: [
       ...
       //{orderable: false, targets: 0},
        ...
        "fnDrawCallback": function (oSettings) {
            ...
            $(".exportData").each(function(){
                $(this).attr("href",$(this).data("href")+"country="+$('#countryN').val()+input);
            });
        },
    ...
    jQuery(document).on('change', '#country', function () {
        ...
        oTable.ajax.url("hitechjobs/city/list?country="+$('#countryN').val()).load();
    });
