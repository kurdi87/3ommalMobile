...
@section('js')
    ...
    <script src="cp/js/usersForm.js" type="text/javascript"></script>
     <script src="cp/js/paymentForm.js" type="text/javascript"></script>

          <script src="cp/js/paymentAtt.js" type="text/javascript"></script>
    <script src="cp/js/paymentProcedure.js" type="text/javascript"></script>
...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\PaymentController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.payment.form')
        {!! Form::close() !!}
                    ...
                    <div class="caption font-dark">
                        ...
                        <div class="btn-group">
                         ...
                         <a title="Add Atts" data-modal="modal-attadd" class="attmodal btn btn-circle btn-icon-only btn-default tooltip-one-info" data-id=""   href="#">
                                                ...
                                                </a> Click Here To Add Atts To This payment
                    </div>
                </div>
