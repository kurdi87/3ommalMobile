...
@section('content')
    <div class="form-package">
        {!! Form::model($result,['action'=>['Admin\CategoryController@update',$result->id],'class'=>'form-validation form-datavalidation']) !!}
        @include('cp.category.form')
        {!! Form::close() !!}
...
<div class="modal fade" id="modal-subadd" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            ...
            {!! Form::open(["id"=>"addSub","class"=>"form-validation "]) !!}
            <div class="modal-body-attach" >

                @include('cp.category.addSub')
...
<div class="modal fade" id="modal-subEdit" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            ...
            {!! Form::open(["id"=>"editSub","class"=>"form-validation "]) !!}
